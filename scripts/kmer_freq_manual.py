...
def main(args):
    ftype  = check_input_format(sys.argv[1])
    n_reads = get_n_reads(sys.argv[1], ftype)
    ...
    for chunk in tqdm(read_chunks):
        ...
        comp_vectors,lengths_d = launch_seq_kmers_pool( sys.argv[1],     \
                                                        ftype,          \
                                                        args.k,         \
                                                        args.threads,   \
                                                        target_range,   \
                                                        ...
                                                        args.count,     \
                                                        args.frac )
        write_output( sys.argv[1], ftype, comp_vectors, lengths_d, target_range )
