...
X = df.loc[:,motifs]
X_embedded = umap.UMAP(n_neighbors=10, min_dist=0, verbose=2).fit_transform(X) #edit 2may22 -> 14jun22 low_memory=True removed for increased speed; n_neigh can be optimised
...
umap_out["bin_id"] = hdbscan.HDBSCAN(min_cluster_size=int(30),min_samples=int(10),cluster_selection_epsilon=0.3).fit_predict(X) #14jun22 min_cluster;  min_samples; epsilon can be optimised
